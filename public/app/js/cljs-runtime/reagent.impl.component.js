...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__11591 = c;
var G__11591__$1 = (((G__11591 == null))?null:G__11591.prototype);
if((G__11591__$1 == null)){
return null;
} else {
return G__11591__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__11596 = c;
var G__11596__$1 = (((G__11596 == null))?null:G__11596.prototype);
if((G__11596__$1 == null)){
return null;
} else {
return G__11596__$1.render;
}
})() == null)))));
});
...
while (G__11695__i < G__11695__a.length) {G__11695__a[G__11695__i] = arguments[G__11695__i + 0]; ++G__11695__i;}
  args = new cljs.core.IndexedSeq(G__11695__a,0,null);
} 
...
var or__5045__auto__ = (function (){var G__11606 = c;
var G__11606__$1 = (((G__11606 == null))?null:G__11606.constructor);
if((G__11606__$1 == null)){
return null;
} else {
return G__11606__$1.displayName;
}
})();
...
var G__11607 = c;
var G__11607__$1 = (((G__11607 == null))?null:G__11607.constructor);
if((G__11607__$1 == null)){
return null;
} else {
return G__11607__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__11608 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__11609 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__11609);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__11608);
}});
reagent.impl.component.rat_opts = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"no-cache","no-cache",1588056370),true], null);
reagent.impl.component.custom_wrapper = (function reagent$impl$component$custom_wrapper(key,f){
var G__11610 = key;
var G__11610__$1 = (((G__11610 instanceof cljs.core.Keyword))?G__11610.fqn:null);
switch (G__11610__$1) {
...
var c = this;
var G__11644_11700 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__11644_11700 == null)){
} else {
reagent.ratom.dispose_BANG_(G__11644_11700);
}
...
var renders_11701 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_11702 = cljs.core.first(cljs.core.vals(renders_11701));
...
if((cljs.core.count(renders_11701) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_11701))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_11702)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_11702], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__11683 = o;
reagent.impl.component.goog$module$goog$object.set(G__11683,cljs.core.name(k),v);
...
return (function() { 
var G__11704__delegate = function (args){
return reagent.impl.protocols.as_element(compiler,cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args));
};
...
while (G__11705__i < G__11705__a.length) {G__11705__a[G__11705__i] = arguments[G__11705__i + 0]; ++G__11705__i;}
  args = new cljs.core.IndexedSeq(G__11705__a,0,null);
} 
return G__11704__delegate.call(this,args);};
...
return G__11704__delegate(args);
});
...
var _STAR_current_component_STAR__orig_val__11684 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__11685 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__11685);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__11684);
}});
...
var vec__11686 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11686,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11686,(1),null);
...
var G__11689 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__11689 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__11689);
}
});
}),[]);
