...
var G__11711 = o;
reagent.impl.template.goog$module$goog$object.set(G__11711,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__11729__delegate = function (args){
...
while (G__11730__i < G__11730__a.length) {G__11730__a[G__11730__i] = arguments[G__11730__i + 0]; ++G__11730__i;}
  args = new cljs.core.IndexedSeq(G__11730__a,0,null);
} 
return G__11729__delegate.call(this,args);};
G__11729.cljs$lang$maxFixedArity = 0;
G__11729.cljs$lang$applyTo = (function (arglist__11731){
var args = cljs.core.seq(arglist__11731);
return G__11729__delegate(args);
});
...
var G__11712 = o;
reagent.impl.template.goog$module$goog$object.set(G__11712,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__11732__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__11733__i < G__11733__a.length) {G__11733__a[G__11733__i] = arguments[G__11733__i + 0]; ++G__11733__i;}
  args = new cljs.core.IndexedSeq(G__11733__a,0,null);
} 
return G__11732__delegate.call(this,args);};
...
return G__11732__delegate(args);
});
...
var G__11713 = props;
var G__11713__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__11713,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__11713);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__11713__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__11714 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__11714,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__11714;
}
})(),id_class);
...
var G__11715 = (cljs.core.count(argv) - first_child);
switch (G__11715) {
case (0):
...
var vec__11716 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11716,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11716,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11716,(2),null);
...
var temp__5808__auto___11747 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___11747 == null)){
} else {
var key_11748 = temp__5808__auto___11747;
(jsprops.key = key_11748);
}
...
var temp__5808__auto___11753 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___11753 == null)){
} else {
var key_11754 = temp__5808__auto___11753;
(jsprops.key = key_11754);
}
...
var temp__5808__auto___11760 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___11760 == null)){
} else {
var key_11761 = temp__5808__auto___11760;
(jsprops.key = key_11761);
}
...
var temp__5808__auto___11768 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___11768 == null)){
} else {
var key_11769 = temp__5808__auto___11768;
(jsprops.key = key_11769);
}
...
var temp__5808__auto___11770 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___11770 == null)){
} else {
var key_11771 = temp__5808__auto___11770;
(jsprops.key = key_11771);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__11719_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__11719_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__11720 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11720,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11720,(1),null);
...
break;
default:
var G__11775 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__11776 = compiler;
v = G__11775;
compiler = G__11776;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template11726 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template11726 = (function (opts,id,fn_to_element,parse_fn,meta11727){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template11726.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_11728,meta11727__$1){
var self__ = this;
var _11728__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template11726(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta11727__$1));
}));

(reagent.impl.template.t_reagent$impl$template11726.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_11728){
var self__ = this;
var _11728__$1 = this;
return self__.meta11727;
}));

(reagent.impl.template.t_reagent$impl$template11726.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template11726.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template11726.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template11726.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template11726.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template11726.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta11727","meta11727",-1323874434,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template11726.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template11726.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template11726");

(reagent.impl.template.t_reagent$impl$template11726.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template11726");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template11726.
 */
reagent.impl.template.__GT_t_reagent$impl$template11726 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template11726(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta11727){
return (new reagent.impl.template.t_reagent$impl$template11726(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta11727));
});

}

return (new reagent.impl.template.t_reagent$impl$template11726(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
