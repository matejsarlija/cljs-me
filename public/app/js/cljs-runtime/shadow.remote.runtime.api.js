...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_18685 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_18685(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_18686 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_18686(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_18687 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_18687(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_18693 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_18693(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_18697 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_18697(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_18698 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_18698(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__18682,callback){
var map__18684 = p__18682;
var map__18684__$1 = cljs.core.__destructure_map(map__18684);
var input = map__18684__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18684__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18684__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
